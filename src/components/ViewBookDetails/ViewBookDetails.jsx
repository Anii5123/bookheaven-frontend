      ...
      {Data && (
        <div className="px-4 md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-8 items-start">
          <div className="w-full lg:w-3/6 ">
            ...
            <div className="bg-zinc-800 flex flex-col lg:flex-row justify-around p-12 rounded">
              ...
              {isLoggedIn === true && role === "user" && (
                <div className="flex flex-col md:flex-row lg:flex-col items-center mt-4 lg:mt-0 justify-between lg:justify-start">
                  <button
                  ...
                  >
                    <FaHeart />
                    {""}
                    <span className="ms-4 lg:hidden">Favourites</span>
                  </button>
                  <button
              ...
              {isLoggedIn === true && role === "admin" && (
                <div className="flex flex-col md:flex-row lg:flex-col items-center mt-4 lg:mt-0 justify-between lg:justify-start">
                  ...
                  <button className="text-red-500 rounded mt-8 md:mt-0 lg:rounded-full text-3xl p-3 lg:mt-8 bg-white flex items-center justify-center">
                    <MdOutlineDelete />{" "}
                    <span className="ms-4 lg:hidden" onClick={deleteBook}>
                      Delete Book
                    </span>
                  </button>
                </div>
          ...
          <div className="p-4 w-full lg:w-3/6">
            ...
            <p className="flex mt-4 text-zinc-100 items-center justify-start">
